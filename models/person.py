...
class Person:
    ...
    DEFAULT_GENDER: ClassVar[str] = "Unknown"
    DEFAULT_DYNASTY_ID: ClassVar[int] = 1
    DEFAULT_EDUCATION: ClassVar[int] = 0

    GENDER_MALE: ClassVar[str] = "Male"
    GENDER_FEMALE: ClassVar[str] = "Female"
    GENDER_UNKNOWN: ClassVar[str] = "Unknown"
    GENDER_OTHER: ClassVar[str] = "Other"

    DATE_UNKNOWN: ClassVar[str] = "Unknown"
    DATE_ALIVE: ClassVar[str] = "Alive"
    DATE_SEPARATOR: ClassVar[str] = "-"
    DATE_PLACEHOLDER: ClassVar[str] = "?"
    ...
    def lifespan_string(self) -> str:
        ...
        birth: str = str(self.birth_year) if self.birth_year is not None else self.DATE_PLACEHOLDER
        death: str = str(self.death_year) if self.death_year is not None else ""
